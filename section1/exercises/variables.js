...
// log that variable to the console.
var declaration = 'Harry Potter must not return to Hogwarts!';
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
//I simply used the most accurate data type that I could for each:
//firstName is a word, so use a string,
//isHungry expects a true or false statement, so use a Boolean,
//numberOfPets is clearly a number, so use a number
