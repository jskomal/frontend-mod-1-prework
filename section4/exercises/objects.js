...
*/
var emailProperties = {
  sender: 'jim@boats.info',
  recipient: 'bill@bigboatlovers.com',
  subject: 'Big boat for sale',
  isRead: true,
  hasAttachment: true,
  dateSent: new Date("2021-7-4")
};
...
var emailsFromJim = [
  {
    sender: 'jim@boats4sail.gov',
    recipient: 'bill@bigboatlovers.com',
    timeStamp: " 6:00 AM October 1, 2021",
    subject: 'Catalina Wine Mixer Next Week',
    isRead:true,
    hasAttachment:false
  },
  {
    sender: 'jim@boats4sail.gov',
    recipient: 'bill@bigboatlovers.com',
    timeStamp: "7:30 AM October 5, 2021",
    subject: "Catalina Wine Mixer Tomorrow Flyer",
    isRead:false,
    hasAttachment:true,
  },
  {
    sender: 'jim@boats4sail.gov',
    recipient: 'bill@bigboatlovers.com',
    timeStamp: " 7:32 AM October 6, 2021",
    subject: "Your Ticket to the Catalina Wine Mixer",
    isRead:true,
    hasAttachment:true,
  }
];
console.log(emailsFromJim);
console.log(emailsFromJim[2]);
