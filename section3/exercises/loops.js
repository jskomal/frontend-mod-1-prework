...
// EXPLAIN: 0 1 2 on separate lines, this is because i (the common symbol for number of iterations) is increasing from 0 to infinity (as prompted by the increment expression) and all results where i < 3 are ended (as the condition statement demands)
